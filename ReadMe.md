...
A modern, cloud-based ERP and accounting platform inspired by TallyPrime.
It is a modern business management platform designed to streamline accounting, inventory, billing, and financial reporting within a single cloud-based system.
...
*   **Video Demonstration**: [Watch the Demo Video](https://drive.google.com/file/d/1EV6GhdeprNO4GahBy0QEQr6DfwGdGRR7/view?usp=sharing)

*   **Live Application**: [smart-erp-rahulstech.vercel.app](https://smart-erp-rahulstech.vercel.app)
