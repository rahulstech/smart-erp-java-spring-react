...
import { useRegister, useIsLoggedIn } from '../hooks/api.hooks';
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-linear-to-br from-[#0c3d7e] via-[#002c66] to-[#001733] p-4 font-sans select-none">
      ...
      >
        ...
        {/* Title requested exactly as "LogIn to SmartErp" in register guidelines */}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          >
            ...
            {isPending ? 'Logging In, please wait' : 'Register'}
          </button>
        </form>
        ...
        <div className="text-center w-full">
          <button
            type="button"
            onClick={() => navigate(APP_ROUTES.LOGIN.path)}
